...
then
  ...
  sed ':b;/IfModule mpm_prefork_module/ba;n;bb;:a;s/\(MaxConnectionsPerChild\).*/\1 '$APACHE_MPM_MAXCONNICTIONSPERCHILD'/;n;/\/IfModule/b;ba' -i /etc/apache2/mods-available/mpm_prefork.conf
fi
